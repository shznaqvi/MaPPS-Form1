...
public class FormContract implements BaseColumns {
    ...
    public FormContract hydrate(Cursor cursor) {
        ...
        this.ROW_member_count = cursor.getString(cursor.getColumnIndex(Sec1Entry.ROW_S4));
        this.ROW_screened_count = cursor.getString(cursor.getColumnIndex(Sec1Entry.ROW_S5));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(Sec1Entry.ROW_S4, this.ROW_member_count == null ? JSONObject.NULL : this.ROW_member_count);
